...
const Upcoming = () => {
  ...
  const getApi = async () => {
    const url = `https://api.themoviedb.org/3/movie/upcoming?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US&page=${pageNum}`;
    ...
    <>
      <div className={`${theme ? "dark" : ""} `}>
        <div className="dark:bg-slate-900 text-black bg-white dark:text-white">
          <div className=" py-6 flex justify-between items-center container mx-auto">
